...
public class Producto {
    ...
    public String toString() {
        return "\n Producto{" + "nombre=" + nombre + ", tipo=" + tipo + ", cantidadBodega=" + cantidadBodega + ", cantidadMinima=" + cantidadMinima + ", valorUnitario=" + valorUnitario + ", totalProductosVendidos=" + totalProductosVendidos + '}';
    }
    ...
    public boolean haySuficienteCantidad (int cantidadSolicitada){
        // SI (Cantidad en bodega  >=  cantidad)
        if (this.cantidadBodega>=cantidadSolicitada)
        // verdadero
            return true;
        else
        //SINO es falso
